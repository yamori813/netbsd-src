 ...
 *	2/2010
 */
#ifndef	_M83UARTREG_H
#define	_M83UARTREG_H
...
#define	M83UART_INTRSPEC(cv, cr, sv, sr) \
	{ IMX_UCR##cr##_##cv, ((cr) - 1), IMX_USR##sr##_##sv, ((sr) - 1), #sv }

static const m83uart_intrspec_t m83uart_intrspec_tab[] = {
/* ipi_uart_rx */
	M83UART_INTRSPEC(RRDYEN,   1, RRDY,      1),
	M83UART_INTRSPEC(IDEN,     1, IDLE,      2),
	M83UART_INTRSPEC(DREN,     4, RDR,       2),
	M83UART_INTRSPEC(RXDSEN,   3, RXDS,      1),
	M83UART_INTRSPEC(ATEN,     2, AGTIM,     1),
/* ipi_uart_tx */
	M83UART_INTRSPEC(TXMPTYEN, 1, TXFE,      2),
	M83UART_INTRSPEC(TRDYEN,   1, TRDY,      1),
	M83UART_INTRSPEC(TCEN,     4, TXDC,      2),
/* ipi_uart_mint */
	M83UART_INTRSPEC(OREN,     4, ORE,       2),
	M83UART_INTRSPEC(BKEN,     4, BRCD,      2),
	M83UART_INTRSPEC(WKEN,     4, WAKE,      2),
	M83UART_INTRSPEC(ADEN,     1, ADET,      2),
	M83UART_INTRSPEC(ACIEN,    3, ACST,      2),
	M83UART_INTRSPEC(ESCI,     2, ESCF,      1),
	M83UART_INTRSPEC(ENIRI,    4, IRINT,     2),
	M83UART_INTRSPEC(AIRINTEN, 3, AIRINT,    1),
	M83UART_INTRSPEC(AWAKEN,   3, AWAKE,     1),
	M83UART_INTRSPEC(FRAERREN, 3, FRAMERR,   1),
	M83UART_INTRSPEC(PARERREN, 3, PARITYERR, 1),
	M83UART_INTRSPEC(RTSDEN,   1, RTSD,      1),
	M83UART_INTRSPEC(RTSEN,    2, RTSF,      2),
	M83UART_INTRSPEC(DTREN,    3, DTRF,      2),
	M83UART_INTRSPEC(RI,       3, DTRF,      2),
	M83UART_INTRSPEC(DCD,      3, DCDDELT,   2),
	M83UART_INTRSPEC(DTRDEN,   3, DTRD,      1),
/* ipd_uart_rx_dmareq */
	M83UART_INTRSPEC(RXDMAEN,  1, RRDY,      1),
	M83UART_INTRSPEC(ATDMAEN,  1, AGTIM,     1),
	M83UART_INTRSPEC(IDDMAEN,  4, IDLE,      2),
/* ipd_uart_tx_dmareq */
	M83UART_INTRSPEC(TXDMAEN,  1, TRDY,      1),
};
#define	M83UART_INTRSPEC_TAB_SZ	\
	(sizeof(m83uart_intrspec_tab) / sizeof(m83uart_intrspec_tab[0]))
 ...
 */
#define	M83UART_RXINTR_USR1	(IMX_USR1_RRDY|IMX_USR1_RXDS|IMX_USR1_AGTIM)
#define	M83UART_RXINTR_USR2	(IMX_USR2_IDLE|IMX_USR2_RDR)
#define	M83UART_TXINTR_USR1	(IMX_USR1_TRDY)
#define	M83UART_TXINTR_USR2	(IMX_USR2_TXFE|IMX_USR2_TXDC)
#define	M83UART_MINT_USR1	(IMX_USR1_ESCF|IMX_USR1_AIRINT||IMX_USR1_AWAKE \
				|IMX_USR1_FRAMERR|IMX_USR1_PARITYERR \
				|IMX_USR1_RTSD|IMX_USR1_DTRD)
#define	M83UART_MINT_USR2	(IMX_USR2_ORE|IMX_USR2_BRCD|IMX_USR2_WAKE \
				|IMX_USR2_ADET|IMX_USR2_ACST|IMX_USR2_IRINT \
				|IMX_USR2_RTSF|IMX_USR2_DTRF|IMX_USR2_DTRF \
				|IMX_USR2_DCDDELT)
#define	M83UART_RXDMA_USR1	(IMX_USR1_RRDY|IMX_USR1_AGTIM)
#define	M83UART_RXDMA_USR2	(IMX_USR2_IDLE)
#define	M83UART_TXDMA_USR1	(IMX_USR1_TRDY)
#define	M83UART_TXDMA_USR2	(0)

/*
 * all intr status flags by reg
 */
#define	M83UART_INTRS_USR1	(M83UART_RXINTR_USR1|M83UART_TXINTR_USR1 \
				|M83UART_MINT_USR1|M83UART_RXDMA_USR1 \
				|M83UART_TXDMA_USR1)
#define	M83UART_INTRS_USR2	(M83UART_RXINTR_USR2|M83UART_TXINTR_USR2 \
				|M83UART_MINT_USR2|M83UART_RXDMA_USR2 \
				|M83UART_TXDMA_USR2)

/*
 * all intr controls by reg
 */
#define	M83UART_INTRS_UCR1	(IMX_UCR1_RRDYEN|IMX_UCR1_IDEN \
...
#define	M83UART_INTRS_UCR2	(IMX_UCR2_ATEN|IMX_UCR2_ESCI|IMX_UCR2_RTSEN)
#define	M83UART_INTRS_UCR3	(IMX_UCR3_RXDSEN|IMX_UCR3_ACIEN \
...
#define	M83UART_INTRS_UCR4	(IMX_UCR4_DREN|IMX_UCR4_TCEN|IMX_UCR4_OREN \
